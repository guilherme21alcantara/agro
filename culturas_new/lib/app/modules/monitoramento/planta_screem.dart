...
class plantaMonitoramentoScreem extends StatefulWidget {
  plantaMonitoramentoScreem({Key? key}) : super(key: key);

  @override
  _plantaMonitoramentoScreemState createState() =>
      _plantaMonitoramentoScreemState();
}

// ignore: camel_case_types
class _plantaMonitoramentoScreemState extends State<plantaMonitoramentoScreem> {
  MonitoramentoController monitoramentoController =
      Get.put<MonitoramentoController>(MonitoramentoController());
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        bottomNavigationBar: const CustomNavigation(paginaAtual: PLANTA),
        appBar: AppBar(
